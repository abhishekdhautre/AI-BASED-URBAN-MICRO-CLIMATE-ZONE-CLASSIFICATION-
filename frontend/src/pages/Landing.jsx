...
import { Thermometer, Satellite, Brain, MapPin, ArrowRight, Globe, Layers, Zap } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#0a0f1e] text-slate-100">
      ...
      <section className="relative px-6 pt-20 pb-16 max-w-6xl mx-auto">
        ...
        <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4 max-w-3xl">
          Urban Micro-Climate &{' '}
          <span className="text-blue-400">Heat Mapping</span>
        </h1>
      ...
      {/* What are LCZs */}
      <section className="px-6 py-12 bg-[#0d1526] border-y border-[#1e2d45]">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <p className="text-xs text-blue-400 font-semibold uppercase tracking-widest mb-3">What are LCZs?</p>
              <h2 className="text-2xl font-bold mb-4">Local Climate Zones</h2>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={label} className="card">
                  ...
                  {items.map(item => (
                    <p key={item} className="text-sm text-slate-300 py-1 border-b border-[#1e2d45] last:border-0">{item}</p>
                  ))}
                </div>
              ))}
            </div>
      ...
      <section className="px-6 py-12 max-w-6xl mx-auto">
        <p className="text-xs text-blue-400 font-semibold uppercase tracking-widest mb-3">Why It Matters</p>
        <h2 className="text-2xl font-bold mb-8">Urban Heat Islands & Climate Resilience</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          {FEATURES.map(({ icon: Icon, title, desc }) => (
            <div key={title} className="card hover:border-blue-600/40 transition-colors">
              <div className="w-9 h-9 rounded-lg bg-blue-600/15 flex items-center justify-center mb-3">
      ...
      <section className="px-6 py-12 bg-[#0d1526] border-y border-[#1e2d45]">
        <div className="max-w-6xl mx-auto">
          <p className="text-xs text-blue-400 font-semibold uppercase tracking-widest mb-3">Methodology</p>
            ...
            {[
              ...
              <div key={step} className="flex-1 flex gap-3">
                <div className="flex flex-col items-center">
                  <div className="w-8 h-8 rounded-full bg-blue-600/20 border border-blue-600/40 flex items-center justify-center text-xs font-bold text-blue-400 shrink-0">
                    {step}
                  </div>
                  {i < 3 && <div className="w-px flex-1 bg-[#1e2d45] mt-2 hidden md:block" />}
                </div>
                <div className="pb-4">
      ...
      <section className="px-6 py-16 text-center max-w-2xl mx-auto">
        ...
        <p className="text-slate-400 mb-6">Upload satellite patches, explore the interactive map, and analyze urban heat patterns across Pune.</p>
